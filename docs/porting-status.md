...
- Full numerical parity across a larger clinical multi-subject DARTEL dataset
  beyond the nineteen real template-derived subjects
...
- SPM DARTEL reference comparison on nineteen real template-derived subjects:
...
full numerical parity across a larger clinical multi-subject DARTEL dataset
beyond the nineteen real template-derived subjects is not yet demonstrated:
...
larger clinical multi-subject DARTEL dataset beyond the nineteen real
