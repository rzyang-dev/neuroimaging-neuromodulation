...
- Full numerical parity across a larger clinical multi-subject DARTEL dataset
  beyond the twenty-one real template-derived subjects
...
- SPM DARTEL reference comparison on twenty-one real template-derived subjects:
...
full numerical parity across a larger clinical multi-subject DARTEL dataset
beyond the twenty-one real template-derived subjects is not yet demonstrated:
...
larger clinical multi-subject DARTEL dataset beyond the twenty-one real
