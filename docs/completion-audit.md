...
- SPM DARTEL multi-subject reference comparison on seven real subjects achieves
...
dataset beyond the seven real template subjects remains to be demonstrated.
