...
7. The migration is partial, not a full port of the original MATLAB toolbox.
   ...
   Missing workflows now include validated AFQ/ANTs integration, TrackQC
   statistical workflow integration, and full SPM/DARTEL-compatible
   segmentation/normalization. See `docs/porting-status.md`.
