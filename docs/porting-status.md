...
- Full numerical parity across a larger clinical multi-subject DARTEL dataset
  beyond the five real template subjects
...
- SPM DARTEL reference comparison on five real subjects: DARTEL-normalized
...
full numerical parity across a larger clinical multi-subject DARTEL dataset
beyond the five real template subjects is not yet demonstrated:
...
larger clinical multi-subject DARTEL dataset beyond the five real template
