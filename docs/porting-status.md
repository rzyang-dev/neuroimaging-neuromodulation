...
- Full numerical parity across a larger clinical multi-subject DARTEL dataset
  beyond the fifteen real template-derived subjects
...
- SPM DARTEL reference comparison on fifteen real template-derived subjects:
...
full numerical parity across a larger clinical multi-subject DARTEL dataset
beyond the fifteen real template-derived subjects is not yet demonstrated:
...
larger clinical multi-subject DARTEL dataset beyond the fifteen real
