...
- Full numerical parity across a larger clinical multi-subject DARTEL dataset
  beyond the twenty-three real template-derived subjects
...
- SPM DARTEL reference comparison on twenty-three real template-derived subjects:
...
full numerical parity across a larger clinical multi-subject DARTEL dataset
beyond the twenty-three real template-derived subjects is not yet demonstrated:
...
larger clinical multi-subject DARTEL dataset beyond the twenty-three real
