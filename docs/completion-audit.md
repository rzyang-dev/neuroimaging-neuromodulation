...
- SPM DARTEL multi-subject reference comparison on seventeen real
  template-derived subjects achieves mean correlation > 0.86.
...
dataset beyond the seventeen real template-derived subjects remains to be
demonstrated.
