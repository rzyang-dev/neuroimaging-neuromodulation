...
- Full numerical parity across a larger clinical multi-subject DARTEL dataset
  beyond the seven real template subjects
...
- SPM DARTEL reference comparison on seven real subjects: DARTEL-normalized
...
full numerical parity across a larger clinical multi-subject DARTEL dataset
beyond the seven real template subjects is not yet demonstrated:
...
larger clinical multi-subject DARTEL dataset beyond the seven real template
subjects remains to be demonstrated. ANTs
