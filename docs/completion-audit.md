...
- SPM DARTEL multi-subject reference comparison on twenty-three real
  template-derived subjects achieves mean correlation > 0.87.
...
dataset beyond the twenty-three real template-derived subjects remains to be
demonstrated.
